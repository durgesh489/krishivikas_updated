...
class TractorList extends StatefulWidget {
  final String category;
  final int categoryId;
  TractorList({Key? key, required this.category, required this.categoryId})
      : super(key: key);

  @override
  State<TractorList> createState() => _TractorListState();
}

class _TractorListState extends State<TractorList> {
  String url = "";
