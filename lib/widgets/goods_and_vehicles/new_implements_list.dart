...
class NewImplementsList extends StatelessWidget {
  NewImplementsList({Key? key}) : super(key: key);
 ...
 var title = ["Universal Mould Board Ploughhhh","Regular Light","Tractor Tipping Trailor",];
