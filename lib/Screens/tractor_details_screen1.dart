...
class TractorDetailsScreen1 extends StatefulWidget {
  final int tractorId;

  TractorDetailsScreen1(this.tractorId);

  @override
  State<TractorDetailsScreen1> createState() => _TractorDetailsScreenState1();
}

class _TractorDetailsScreenState1 extends State<TractorDetailsScreen1> {
  String url = "";
